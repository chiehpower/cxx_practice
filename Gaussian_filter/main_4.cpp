...
int main(int argc, char** argv)
{
    ...
    GaussianBlur(image, image_blurred_with_3x3_kernel, Size(3, 3), 4);

    //Blur the image with 5x5 Gaussian kernel
    Mat image_blurred_with_5x5_kernel;
    GaussianBlur(image, image_blurred_with_5x5_kernel, Size(23, 23), 4);

    // imwrite("3by3writeimage.png", image_blurred_with_3x3_kernel);
    imwrite("5by5writeimage.png", image_blurred_with_5x5_kernel);
